...
def process_message(target_id, text, is_admin_sender):
    ...
    # ⚠️ ส่วนแจ้งเตือน (เปลี่ยนข้อความใหม่ตรงนี้)
    if unknown_codes:
        msg = (
            "⚠️ ขออภัยครับ ไม่พบภาพถาดถวายตามรหัสที่ท่านระบุ\n"
            "อาจเนื่องจากพิธีกรรมยังไม่เริ่มต้น หรือรหัสที่ระบุอาจคลาดเคลื่อนครับ 🙏"
        )
        send_message(target_id, msg)
